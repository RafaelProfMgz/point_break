Aqui está uma descrição detalhada e profissional para o seu `README.md`, baseada exatamente na estrutura de arquivos que você construiu e nas funcionalidades implementadas (Landing Page, Auth, Dashboard, Time, Perfil, etc.).

Você pode copiar e colar o conteúdo abaixo no final do seu arquivo `README.md`:
...
O projeto foi construído utilizando as melhores práticas do **Next.js 15 (App Router)**, totalmente tipado com **TypeScript** e componentizado com **Shadcn/ui**.
...
```bash
git clone https://github.com/SEU_USUARIO/point_break.git
```
